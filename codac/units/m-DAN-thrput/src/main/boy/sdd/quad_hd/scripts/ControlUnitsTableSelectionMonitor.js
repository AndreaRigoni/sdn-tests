...
// change $(CU) substitution
        ...
        if (cuType == "POC with CA") {
            ...
            ScriptUtil.openOPI(display.getWidget("Table"), fct_name+"-PSHDetails.opi", 1, macroInput)
        }
        else if (cuType == "Fast Controller") {
            ScriptUtil.openOPI(display.getWidget("Table"), fct_name+"-PCFDetails.opi", 1, macroInput)
        }
        else if (cuType == "Server") {
            ScriptUtil.openOPI(display.getWidget("Table"), fct_name+"-SRVDetails.opi", 1, macroInput)
        }
        else {
