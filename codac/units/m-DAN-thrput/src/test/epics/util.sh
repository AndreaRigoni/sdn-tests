#+======================================================================
# $HeadURL: https://svnpub.iter.org/codac/iter/codac/dev/units/m-codac-unit-api/tags/CODAC-CORE-5.4.0/src/main/resources/util.sh $
# $Id: util.sh 75208 2017-02-03 09:19:23Z cesnikt $
#
