#!/bin/bash
#+======================================================================
# $HeadURL: https://svnpub.iter.org/codac/iter/codac/dev/units/m-codac-unit-api/tags/CODAC-CORE-5.4.0/src/main/resources/test_template.sh $
# $Id: test_template.sh 75208 2017-02-03 09:19:23Z cesnikt $
#
